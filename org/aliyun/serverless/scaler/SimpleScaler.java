...
/*
* README
* This file is archived as a simplest reference
* */
...
//            hacker.addHandler(fileHandler);
    ...
    public void Assign(Context ctx, SchedulerProto.AssignRequest request, StreamObserver<SchedulerProto.AssignReply> responseObserver) throws Exception {
        ...
        try {
            ...
            MetaHackerDo metaHackerDo = new MetaHackerDo(function.getKey(), function.getRuntime(), Integer.MAX_VALUE, Long.MAX_VALUE, instance.getInitDurationInMs());
            hacker.info("#####INITDURA#####" + JSON_MAPPER.writeValueAsString(metaHackerDo));
                    ...
                    if (instance != null) {
                        ...
                        if (idleDuration > config.getIdleDurationBeforeGC().toMillis()) {
                            ...
                            logger.info(String.format("Instance %s of app %s is GCed due to idle for %dms",
                                    instance.getInstanceId(), instance.getMeta().getKey(), idleDuration));
                        }
                    }
                }
                mu.unlock();
    ...
    public void HackAssignRequestData(SchedulerProto.AssignRequest request) throws Exception {
    ...
    public void HackIdleRequestData(SchedulerProto.IdleRequest request) throws Exception {
